...
pub trait StaticBinding: Binding {
    fn static_layout_entry() -> BindingLayoutEntry;
}

pub trait BindingSet {
    // fn static_layout_desc() -> BindingSetLayoutDescriptor;
...
mod tests {
    ...
    use crate::{
        render::resource::uniform::{GpuUniform, HandleGpuUniform, Uniform},
        texture::Texture,
    };
